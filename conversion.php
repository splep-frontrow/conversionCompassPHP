...
if ($sessionTokenPayload !== null) {
    ...
    error_log("conversion.php: Session token validated successfully for shop: {$shop}");
} else {
    error_log("conversion.php: Session token validation failed or missing for shop: {$shop}, falling back to access token method");
}
